    ...
    case board.card_skin do
      "stars" ->
        ...
        <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class={classes}>
         ...
         <rect x=".5" y=".5" width="23" height="23" ry="1.92" fill="#c4c6ca" stroke="url(#tc)" class="fill-[#f0f2f5] dark-t:fill-theme-3" />
      ...
      "engage" ->
        ...
        <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class={classes}>
          ...
          <rect x=".5" y=".5" width="23" height="23" ry="1.92" stroke="url(#tc)" class="fill-[#f0f2f5] dark-t:fill-theme-3" />
      ...
      "diamonds" ->
        ...
        <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class={classes}>
          ...
          <path d="m2.92 2c-0.509 0-0.918 0.409-0.918 0.918v0.674l0.918-1.59zm2.16 0 0.918 1.59 0.918-1.59h-1.84zm4 0 0.918 1.59 0.918-1.59h-1.84zm4 0 0.918 1.59 0.918-1.59h-1.84zm4 0 0.918 1.59 0.918-1.59h-1.84zm4 0 0.918 1.59v-0.674c0-0.509-0.409-0.918-0.918-0.918zm-17.1 1.08-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm-18 3.47v3.98l1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99v-3.98zm-18 3.47-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm-18 3.47v3.98l1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99v-3.98zm-18 3.46-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm4 0.00195-1.15 1.99 1.15 1.99 1.15-1.99-1.15-1.99zm-18 3.46v0.672c0 0.509 0.409 0.918 0.918 0.918l-0.918-1.59zm4 0-0.918 1.59h1.84l-0.918-1.59zm4 0-0.918 1.59h1.84l-0.918-1.59zm4 0-0.918 1.59h1.84l-0.918-1.59zm4 0-0.918 1.59h1.84l-0.918-1.59zm4 0-0.918 1.59c0.509 0 0.918-0.409 0.918-0.918v-0.672z" fill="url(#tc)" />
        </svg>
        """
