defmodule Engage.Repo.Migrations.CreateUsersAuthTables do
  ...
  def change do
    ...
    create_theme_query = "CREATE TYPE theme AS ENUM ('dark', 'light', 'automatic')"
    drop_theme_query = "DROP TYPE theme"
    execute(create_theme_query, drop_theme_query)
