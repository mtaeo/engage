defmodule EngageWeb.UserAuthTest do
  use EngageWeb.ConnCase, async: true

  alias Engage.Users
  alias EngageWeb.UserAuth
  import Engage.UsersFixtures

  @remember_me_cookie "_engage_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EngageWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      EngageWeb.Endpoint.subscribe(live_socket_id)
